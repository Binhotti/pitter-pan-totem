  ...
  <main class="app">
    <header class="topbar topbar--hidden" id="topbar">
      ...
      <div class="topbar__center">
        <img class="topbar__logo" src="assets/logo-pitter-pan.png" alt="Pitter Pan Festas">
    ...
    <section class="screen screen--active welcome-screen" data-screen="welcome">
      <div class="welcome-card">
        <img class="welcome-card__logo" src="assets/logo-pitter-pan.png" alt="Pitter Pan Festas">
